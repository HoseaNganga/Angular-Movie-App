...
describe('MoviesComponent', () => {
  ...
  it('should render slider and carousel components with correct inputs', fakeAsync(() => {
    ...
    const mockMoviesData = [{ id: 1, title: 'Movie 1', link: '/movie/1' }];
    ...
    tick(4000);
    component.movies_data = mockMoviesData;
    component.movieCategories['popularMovies'] = mockCategoryData;
    component.movieCategories['topRatedMovies'] = mockCategoryData;
    component.movieCategories['upcomingMovies'] = mockCategoryData;
    component.movieCategories['nowPlayingMovies'] = mockCategoryData;

    fixture.detectChanges();

    const sliderDebugElement = fixture.debugElement.query(By.css('app-slider'));
    expect(sliderDebugElement).toBeTruthy();
    expect(sliderDebugElement.componentInstance.data).toEqual(mockMoviesData);
